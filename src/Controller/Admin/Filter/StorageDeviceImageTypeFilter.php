...
use App\Form\Type\Admin\StorageDeviceImageFilterType;
...
class StorageDeviceImageTypeFilter implements FilterInterface
{
    use FilterTrait;
    ...
    public static function new(string $propertyName, $label = null): self
    {
        return (new self())
            ...
            ->setLabel($label)
            ->setFormType(StorageDeviceImageFilterType::class);
    }
    ...
    public function apply(QueryBuilder $queryBuilder, FilterDataDto $filterDataDto, ?FieldDto $fieldDto, EntityDto $entityDto): void
    {
        ...
        if ('6' === $filterDataDto->getValue()) {
            $queryBuilder
                ->andWhere("entity.type = '6'");
        }
    }
}