...
class ChipsetDocumentationCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return ChipsetDocumentation::class;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setEntityLabelInPlural('<img class=ea-entity-icon src=/build/icons/manual.svg width=48 height=48>Chipset documentation')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield UrlField::new('file_name')
            ->setCustomOption('link','chipset/documentation/')
            ->hideOnForm();
