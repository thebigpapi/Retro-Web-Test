...
use App\Repository\ExpansionChipBiosRepository;
...
#[Vich\Uploadable]
#[ORM\Entity(repositoryClass: ExpansionChipBiosRepository::class)]
class ExpansionChipBios
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[Vich\UploadableField(mapping: 'chipbios', fileNameProperty: 'file_name')]
