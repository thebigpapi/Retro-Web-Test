...
class KnownIssueExpansionCardType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            ...
            'choice_label' => 'name',
            'choices' => $this->entityManager->getRepository(KnownIssue::class)->findAllByType(KnownIssueType::ExpansionCards),
            'multiple' => false,
            'expanded' => false,
