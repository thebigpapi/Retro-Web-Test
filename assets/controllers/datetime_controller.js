...
export default class extends Controller {
    ...
    changeTime(id) {
        ...
        for (let element of list) {
            ...
            element.children[0].innerHTML = date.toLocaleString(navigator.language, {year: 'numeric', month: 'numeric', day: 'numeric', hour: '2-digit', minute: '2-digit', timeZoneName:'short'});
